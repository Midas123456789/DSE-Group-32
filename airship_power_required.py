...
class PropPowerAirship:
    ...
    def calculate_power(self):
        prop_power_req = (self.airship_velocity*((self.airship_CD0 + self.drag_factor_K * self.airship_CLaero**2) * 0.5 * self.rho * self.airship_velocity**2 * self.airship_refrencearea)) / (self.prop_efficiency) #ft-lb/s
        prop_power_req = prop_power_req * (1.35582/1000)  # Convert from ft-lb/s to kWatts
        return prop_power_req
