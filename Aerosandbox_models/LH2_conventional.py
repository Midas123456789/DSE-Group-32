...
class Conventional_LH:
    def __init__(self, N_cords = 5, wing_airfoil = asb.Airfoil("sd7037"), altitude = 18e3, mission_days = 7, W_payload = 1e3, P_payload = 5e3, tail_drag_factor = 1.1):
        #GEOMETRY
