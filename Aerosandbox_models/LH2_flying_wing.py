...
class FlyingWing_LH:
    def __init__(self, N_cords = 5, wing_airfoil = asb.Airfoil("sd7037"), altitude = 18e3, mission_days = 7, W_payload = 1e3, P_payload = 5e3, tail_drag_factor = 1.01):
        #GEOMETRY
    ...
    def _setup_aero(self):
        ...
        self.L = 0.5 * self.atm.density() * self.V**2 * self.aero['CL'] * self.wing.area()
        self.D = 0.5 * self.atm.density() * self.V**2 * self.aero['CD'] * self.wing.area() * self.tail_drag_factor
    ...
    def _get_spar(self):
        spar_mass, t_list = self.wing.spar_mass(self.L, self.b)
    ...
    def compute_weights(self):
        ...
        self.W_skin = 2 * self.wing.area() * skin_density * self.g
    ...
    def solve(self):
        ...
        self.solution = {
            ...
            "b": sol.value(self.b),
            "wing_area": sol.value(self.wing.area()),
    ...
    def print_solution(self):
        sol = self.solution
        print("\n--- HYDROGEN FLYING WING OPTIMIZATION RESULTS ---\n")
